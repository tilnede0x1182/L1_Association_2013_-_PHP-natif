...
<?php
	...
	<p class="texte1"> President : Jean <br>presidence.aaeipd@gmail.com</p>
	...
	<p class="texte1"> redacteur : Laurent <br>redacteur.aaeipd@gmail.com</p>
	<p class="texte1"> Administrateurs : Gabriel <br>gabriel.leblanc@universite_paris_7.etudiant.fr</p>

	<p class="texte1"> Administrateurs : Philippe <br>philippe.albin@universite_paris_7.etudiant.fr</p>
