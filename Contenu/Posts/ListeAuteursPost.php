<?php session_start();
	...
	if ((!empty($_SESSION['pageCourante'])) && (substr($_SESSION['pageCourante'],0,45)!=$serveur."Contenu/Posts/ListeAuteursPost.php")) $pageprecedente = $_SESSION['pageCourante'];
	else $pageprecedente = "";
	$_SESSION['pageCourante']=$serveur."Contenu/Posts/ListeAuteursPost.php";
