...
<nav id="menuAcceuil">
	<ul>
		<li><a href="<?= $serveur ?>Accueil/index.php">Accueil</a></li>
...
<div class="accesMembre">
	<p>Accès membres :</p>
	<form action="<?= $serveur ?>Auth/Connexion.php" method="POST">
...
<?php else: ?>
		<li><a href="<?= $serveur ?>Auth/Deconnexion.php">Se déconnecter</a></li>
		<li><a href="<?= $serveur ?>Membres/MonCompte.php">Modifier mes informations</a></li>
		<li><a href="<?= $serveur ?>Membres/Liste.php">Voir la liste des membres</a></li>
	</ul>
</nav>

<nav class="listeGauche">
	<ul>
		<li><a href="<?= $serveur ?>Contenu/Projets/Liste.php">Projets</a></li>
<?php if ($estAdmin): ?>
		<li><a href="<?= $serveur ?>Contenu/Articles/Creer.php">Ecrire un nouvel article</a></li>
<?php endif; ?>
	</ul>
</nav>
