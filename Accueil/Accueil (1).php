...
<?php
	...
	if (!$connexion) {
		...
		if (!$connexion) {
			...
			echo '<a href="'.$serveur.'Contenu/Posts/ListeCompletePosts.php">Afficher la liste complète</a>';
